...
SEO_KEYWORDS = [
    ...
    "сон", "значение снов", "во сне", "видеть во сне", "сонник онлайн",
    "сонник нейросеть", "кошмар", "сонник толкование", "сонник толкование бесплатно"
]
...
def generate_post(topic, platform, length, style):
    try:
        ...
        Формат текста: {"короткий и емкий, в 1-2 абзаца" if length == "short" else "лонгрид, в 4-5 абзацев с заголовками и примерами"}.
